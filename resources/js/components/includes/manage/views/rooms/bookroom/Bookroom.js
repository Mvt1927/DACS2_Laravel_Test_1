...
class Bookroom extends Component {
    ...
    getbookroom() {
        axios.get(MyGlobleSetting.url + '/api/control/get/bookroom-reserve-waiting')
            .then(response => {
                                    ...
                                    <div className="h-100">
                                        <CRow className="border border-dark">
                                            <CCol className="mb-3 mt-3">
                                                ...
                                                <CInputGroup>
                                                    <CFormInput type="text" id="Find_code_FormControlInput" name="Find_code_FormControlInput" placeholder="Reservation code or phone number" value={this.state.Find_code_FormControlInput} onChange={(event) => this.find(event)} />
                                ...
                                <CCol xs={12} lg={5} className="border border-dark">
                                    <CRow xs={{ cols: 1 }}>
                                        <CCol xs={12} id="Book_Room_Form_Container_Name" className="mb-1 mt-2">
                                            ...
                                            <CFormInput type="text" name="Book_Room_Form_Input_Name" value={this.state.Book_Room_Form_Input_Name} onChange={this.isChange} placeholder="Nguyen Van A" />
                                        </CCol>
                                        <CCol xs={12} id="Book_Room_Form_Container_Date_Of_Birth" className="mb-1 mt-1">
                                            <CFormLabel htmlFor="Book_Room_Form_Input_Date_Of_Birth">Date of birth</CFormLabel>
                                            <CFormInput type="date" name="Book_Room_Form_Input_Date_Of_Birth" value={this.state.Book_Room_Form_Input_Date_Of_Birth} onChange={this.isChange} placeholder="dd/mm/yyyy" />
                                        </CCol>
                                        <CCol xs={12} id="Book_Room_Form_Container_CCCD" className="mb-1 mt-1">
                                            <CFormLabel htmlFor="Book_Room_Form_Input_CCCD">CCCD/CMND/Passport</CFormLabel>
                                            <CFormInput type="number" name="Book_Room_Form_Input_CCCD" value={this.state.Book_Room_Form_Input_CCCD} onChange={this.isChange} placeholder="123456789" min='1' max='9999999999' />
                                        </CCol>
                                        <CCol xs={12} id="Book_Room_Form_Container_Phone" className="mb-1 mt-1">
                                            <CFormLabel htmlFor="Book_Room_Form_Input_Phone">Number phone</CFormLabel>
                                            <CFormInput type="number" name="Book_Room_Form_Input_Phone" value={this.state.Book_Room_Form_Input_Phone} onChange={this.isChange} placeholder="0123456789" min='1' max='9999999999' />
                                        </CCol>
                                        <CCol xs={12} id="Book_Room_Form_Container_Number_Of_People" className="mb-1 mt-1">
                                            <CFormLabel htmlFor="Book_Room_Form_Input_Number_Of_People">Number Of People</CFormLabel>
                                            <CFormInput type="number" name="Book_Room_Form_Input_Number_Of_People" value={this.state.Book_Room_Form_Input_Number_Of_People} onChange={this.isChange} min='1' max='50' />
                                        </CCol>
                                        <CCol xs={12} id="Book_Room_Form_Container_Number_Of_Days_Stay" className="mb-1 mt-1">
                                            <CFormLabel htmlFor="Book_Room_Form_Input_Number_Of_Days_Stay">Number Of Days Stay</CFormLabel>
                                            <CFormInput type="number" name="Book_Room_Form_Input_Number_Of_Days_Stay" value={this.state.Book_Room_Form_Input_Number_Of_Days_Stay} onChange={this.isChange} min='1' max='50' />
                                        </CCol>
                                        <CCol xs={12} id="Book_Room_Form_Container_Room_Code" className="mb-1 mt-1">
