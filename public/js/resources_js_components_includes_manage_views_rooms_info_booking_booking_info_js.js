"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_includes_manage_views_rooms_info_booking_booking_info_js"],{
...
/***/ "./resources/js/components/includes/manage/views/rooms/info_booking/booking_info.js":
/*!******************************************************************************************!*\
  !*** ./resources/js/components/includes/manage/views/rooms/info_booking/booking_info.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Booking_info = /*#__PURE__*/function (_Component) {
  _inherits(Booking_info, _Component);

  var _super = _createSuper(Booking_info);

  function Booking_info(props) {
    var _this;

    _classCallCheck(this, Booking_info);
    ...
    _defineProperty(_assertThisInitialized(_this), "find", function (event) {
      ...
      _this.setState({
        Find_Reservation_FormControlInput: event.target.value,
        loading_find: true,
        currentPage: '1'
      });
      ...
      if (data != null) {
        var filteredData = data.filter(function (element) {
          return element.id.toString().toLowerCase().includes(searchString.toLowerCase()) || element.name.toString().toLowerCase().includes(searchString.toLowerCase()) || element.phone.toString().toLowerCase().includes(searchString.toLowerCase()) || element.date.toString().toLowerCase().includes(searchString.toLowerCase()) || element.stats.toString().toLowerCase().includes(searchString.toLowerCase());
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "save", function (event, id) {
      ...
      if (_this.state[id] != null && _this.state[id] == false) {
        ...
        var bookroom_reserve_stats = {
          id: id,
          stats: _this.state['stats_' + id]
        };
        var url = _MyGlobleSetting__WEBPACK_IMPORTED_MODULE_3__["default"].url + '/api/control/post/edit-bookroom-reserve-stats';
        axios__WEBPACK_IMPORTED_MODULE_1___default().post(url, bookroom_reserve_stats).then(function (response) {
          _this.getBookroom_reserve();

          _this.getBookroom_reserveData();
    ...
    _this.state = {
      Find_Reservation_FormControlInput: "",
      loading_find: false,
      currentPage: '1',
      pageNumbers: '1',
  ...
  _createClass(Booking_info, [{
    key: "getBookroom_reserve",
    value: function getBookroom_reserve() {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_1___default().get(_MyGlobleSetting__WEBPACK_IMPORTED_MODULE_3__["default"].url + '/api/control/get/bookroom-reserve').then(function (response) {
                ...
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CRow, {
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CCol, {
                    ...
                    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CFormLabel, {
                      htmlFor: "Find_Reservation_FormControlInput",
                      children: "Reservation code or name"
                      ...
                      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_0__.CFormInput, {
                        type: "text",
                        id: "Find_Reservation_FormControlInput",
                        name: "Find_Reservation_FormControlInput",
                        placeholder: "Reservation code or name",
                        defaultValue: this.state.Find_Reservation_FormControlInput,
                        onChange: function onChange(event) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Booking_info);
